...
def search_products(request):
    ...
    html = render_to_string("sale/partials/product_list.html", {
        "products": page_obj,
        "page_obj": page_obj,
...
def sale_create(request):
    """
    Cria uma nova venda a partir do formulário.
    """
...
def sale_delete(request, sale_id):
    ...
    return render(request, "sale/sale_delete_confirm.html", {"sale": sale})
